...
let onFloor = false;
let reset = false, activeText = false, canMove = true; // variavel para resetar os baloes
...
class Game extends Phaser.Scene {
    ...
    create() {
        ...
        //parallax
        l1 = this.add.tileSprite(this.sys.canvas.width / 2, this.sys.canvas.height / 2, this.sys.canvas.width, this.sys.canvas.height, 'sky');
        l1.setScrollFactor(0);
        l2 = this.add.tileSprite(this.sys.canvas.width / 2, this.sys.canvas.height / 2, this.sys.canvas.width, this.sys.canvas.height, 'cloudbg');
        l2.setScrollFactor(0);
        l3 = this.add.tileSprite(this.sys.canvas.width / 2, this.sys.canvas.height / 2, this.sys.canvas.width, this.sys.canvas.height, 'mountain1');
        l3.setScrollFactor(0);
        l4 = this.add.tileSprite(this.sys.canvas.width / 2, this.sys.canvas.height / 2, this.sys.canvas.width, this.sys.canvas.height, 'cloudmg3');
        l4.setScrollFactor(0);
        l5 = this.add.tileSprite(this.sys.canvas.width / 2, this.sys.canvas.height / 2, this.sys.canvas.width, this.sys.canvas.height, 'cloudmg2');
        l5.setScrollFactor(0);
        l6 = this.add.tileSprite(this.sys.canvas.width / 2, this.sys.canvas.height / 2, this.sys.canvas.width, this.sys.canvas.height, 'cloudmg1');
        l6.setScrollFactor(0);
        l7 = this.add.tileSprite(this.sys.canvas.width / 2, (this.sys.canvas.height / 2) +50, this.sys.canvas.width, this.sys.canvas.height, 'cloudmg3');
        l7.setScrollFactor(0);
        l8 = this.add.tileSprite(this.sys.canvas.width / 2, (this.sys.canvas.height / 2) +50, this.sys.canvas.width, this.sys.canvas.height, 'cloudmg2');
        l8.setScrollFactor(0);
        l9 = this.add.tileSprite(this.sys.canvas.width / 2, (this.sys.canvas.height / 2) +50, this.sys.canvas.width, this.sys.canvas.height, 'cloudmg1');
        l9.setScrollFactor(0);
        l10 = this.add.tileSprite((this.sys.canvas.width / 2)+278,this.sys.canvas.height / 2, this.sys.canvas.width, this.sys.canvas.height, 'cloud1');
        l10.setScrollFactor(0); 
        l11 = this.add.tileSprite((this.sys.canvas.width / 2)-120,(this.sys.canvas.height / 2) +50, this.sys.canvas.width, this.sys.canvas.height, 'cloud1');
        l11.setScrollFactor(0); 
        l12 = this.add.tileSprite((this.sys.canvas.width / 2)+45,(this.sys.canvas.height / 2) -20, this.sys.canvas.width, this.sys.canvas.height, 'cloud1');
        l12.setScrollFactor(0); 
        l13 = this.add.tileSprite((this.sys.canvas.width / 2)+220,this.sys.canvas.height / 2, this.sys.canvas.width, this.sys.canvas.height, 'cloud1');
        ...
        ceiling.setCollisionByProperty({ collides: true});
...
//*********************************************************************************************************************
        ...
        space.on('down', function(event) {
            if (onFloor){
                player.body.setVelocity(player.body.velocity.x, player.body.velocity.y -80);
            }
        });
    ...
    update() {
        ...
        if(player.body.velocity.y > 150 || reset){
            //resetabaloes();
            //reset = false;
        }
